...
class AnimalSystem():
    def __init__(self, entities, map, entity_creator):
    ...
    def update(self):
        for entity in self.entities.values():
            if 'Animal' in entity and 'Hunger' in entity and 'Health' in entity and entity['Health'].is_alive:
                ...
                if behavior:
                    behavior.update(entity, self.entities, self.map)
    ...
    def become_adult(self, entity):
        ...
        self.entity_creator.morth_target_to(entity, animal.adult_name)
